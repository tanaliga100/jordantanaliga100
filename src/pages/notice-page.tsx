    ...
    <div className="flex min-h-full items-end justify-center  text-center sm:items-center sm:p-0">
      ...
      <p className="text-sm text-gray-500 border-2 p-2 bg-gray-300 md:bg-transparent md:border-none">
            ...
            <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
              ...
              <button type="button" className={`inline-flex w-full justify-center rounded-md  px-3 py-2 text-sm font-semibold text-white shadow-sm border-2 sm:ml-3 sm:w-auto tracking-widest ${!agreed ? "bg-transparent text-black duration-500  border-2" : 'duration-500 bg-red-600'}`
